...
[AddComponentMenu("uScript/Graphs/AdsForTokens")]
public class AdsForTokens_Component : uScriptCode
{
   #pragma warning disable 414
   public AdsForTokens ExposedVariables = new AdsForTokens( ); 
      ...
      {
         {
            ...
            gameObject = GameObject.Find( "AddTokens" ); 
