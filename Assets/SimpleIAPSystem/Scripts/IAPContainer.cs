...
namespace SIS
{
    ...
    public class IAPContainer : MonoBehaviour
    {
        ...
        public IEnumerator Start()
        {
            ...
            if(vLayout != null && rectTrans != null)
            {
                IAPItem[] children = this.GetComponentsInChildren<IAPItem>(false);
                ...
                float newHeight = child.rect.height * children.Length;
                newHeight += (children.Length - 1) * (vLayout.spacing);
                rectTrans.sizeDelta = new Vector2(rectTrans.sizeDelta.x, newHeight);
            }
        }
    }
